...
LOG_FILE="${LOG_PATH}/Megatron-llama_${SEQ_LENGTH}_DP${DP_SIZE}_TP${TP_SIZE}_PP${PP_SIZE}_${MTIME}.log"
...
# 执行训练命令
# torchrun --master_addr=$MASTER_ADDR --node_rank=$NODE_RANK --nnodes=${NNODES} --nproc_per_node=8 --master_port=29500 /data/haiqwa/zevin_nfs/code/Megatron-LLaMA/pretrain_llama.py ${options}
torchrun --nproc_per_node=8 --master_port=29502 /data/haiqwa/zevin_nfs/code/Megatron-LLaMA/pretrain_llama.py ${options}
