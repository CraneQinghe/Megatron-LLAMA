...
LOG_FILE="/data/haiqwa/zevin_nfs/code/Megatron-LLaMA/examples/LLaMA/logs/Megatron-llama_${SEQ_LENGTH}_DP${DP_SIZE}_TP${TP_SIZE}_PP${PP_SIZE}_$(date +%Y%m%d_%H%M%S).log"
