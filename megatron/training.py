...
def train(forward_step_func, model, optimizer, opt_param_scheduler,
    ...
    prof=torch.profiler.profile(
                ...
                on_trace_ready=torch.profiler.tensorboard_trace_handler(f"/data/haiqwa/zevin_nfs/code/Megatron-LLaMA/examples/LLaMA/logs/tensorbroad/{date_str}/{time_str}",torch.distributed.get_rank()),
                record_shapes=True,
                profile_memory=True,
                with_stack=True)
